...
namespace EmployeeDB.DAL.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@EmployeeCode", DbType.AnsiString, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@MiddlesName", DbType.String, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@Bio", DbType.String, DBNull.Value);
		database.AddInParameter(commandWrapper, "@CreatedOn", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("employeecode ") || clause.Trim().StartsWith("employeecode="))
				{
					database.SetParameterValue(commandWrapper, "@EmployeeCode", 
				...
				if (clause.Trim().StartsWith("middlesname ") || clause.Trim().StartsWith("middlesname="))
				{
					database.SetParameterValue(commandWrapper, "@MiddlesName", 
				...
				if (clause.Trim().StartsWith("bio ") || clause.Trim().StartsWith("bio="))
				{
					database.SetParameterValue(commandWrapper, "@Bio", 
						clause.Trim().Remove(0,3).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override EmployeeDB.BLL.Employee GetByEmployeeId(TransactionManager transactionManager, System.Int32 _employeeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Employee_GetByEmployeeId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, EmployeeDB.BLL.Employee entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
            ...
            database.AddInParameter(commandWrapper, "@EmployeeCode", DbType.AnsiString, entity.EmployeeCode );
            ...
            database.AddInParameter(commandWrapper, "@MiddlesName", DbType.String, entity.MiddlesName );
            ...
            database.AddInParameter(commandWrapper, "@Bio", DbType.String, entity.Bio );
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, EmployeeDB.BLL.Employee entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
